...
public class WeightedQuickUnionUF {
    ...
    private int[] largest;  // largest element in each component
    /**
    ...
    /**
     * Returns the largest element in the component, object {@code p} belongs to.
     *
     * @param  p the integer representing one object
     * @return the largest element in component of site {@code p}
     * @throws IndexOutOfBoundsException unless {@code 0 <= p < n}
     */
    ...
    public static void main(String[] args) {
        ...
        while (scan.hasNext()) {
            ...
            uf.union(p, q);
            System.out.println(p + " " + q + " largest element is " + uf.findLargest(p));
        }
